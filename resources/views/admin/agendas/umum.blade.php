...
@section('title', 'Kelola Agenda Umum')

@section('content')
<div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 25px;">
    <div>
        <h2 style="font-size: 1.5rem; font-weight: 700; color: var(--text-dark); margin-bottom: 5px;">Kelola Agenda Umum</h2>
        <p style="color: var(--text-light); font-size: 0.9rem;">Manajemen dan pembaruan agenda kedinasan umum</p>
    </div>
...
<div style="background: white; border-radius: 12px; border: 1px solid var(--border); padding: 20px; margin-bottom: 25px;">
    <form action="{{ route('admin.agendas.umum') }}" method="GET" style="display: flex; gap: 15px; flex-wrap: wrap;">
